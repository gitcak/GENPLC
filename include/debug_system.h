...
// Production-aware logging macros
#if PRODUCTION_BUILD
#define PROD_LOG_ERROR(fmt, ...)   LOG_MACRO(DEBUG_LOG_LEVEL_ERROR,   "ERROR: " fmt, ##__VA_ARGS__)
#define PROD_LOG_WARN(fmt, ...)    LOG_MACRO(DEBUG_LOG_LEVEL_WARN,    "WARN: " fmt, ##__VA_ARGS__)
#define PROD_LOG_INFO(fmt, ...)    LOG_MACRO(DEBUG_LOG_LEVEL_INFO,    "INFO: " fmt, ##__VA_ARGS__)
#define PROD_LOG_DEBUG(fmt, ...)   // Disabled in production
#define PROD_LOG_VERBOSE(fmt, ...) // Disabled in production
#else
#define PROD_LOG_ERROR(fmt, ...)   LOG_MACRO(DEBUG_LOG_LEVEL_ERROR,   "ERROR: " fmt, ##__VA_ARGS__)
#define PROD_LOG_WARN(fmt, ...)    LOG_MACRO(DEBUG_LOG_LEVEL_WARN,    "WARN: " fmt, ##__VA_ARGS__)
#define PROD_LOG_INFO(fmt, ...)    LOG_MACRO(DEBUG_LOG_LEVEL_INFO,    "INFO: " fmt, ##__VA_ARGS__)
#define PROD_LOG_DEBUG(fmt, ...)   LOG_MACRO(DEBUG_LOG_LEVEL_DEBUG,   "DEBUG: " fmt, ##__VA_ARGS__)
#define PROD_LOG_VERBOSE(fmt, ...) LOG_MACRO(DEBUG_LOG_LEVEL_VERBOSE, "VERBOSE: " fmt, ##__VA_ARGS__)
#endif
