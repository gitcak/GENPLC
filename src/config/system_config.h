...
// On StampS3, default I2C is SDA=13, SCL=15
#define PLC_I2C_SDA_PIN 13
#define PLC_I2C_SCL_PIN 15
...
#define PRODUCTION_BUILD 0  // Set to 1 for production builds
#define PRODUCTION_LOG_LEVEL LOG_LEVEL_INFO  // Only INFO and above in production
